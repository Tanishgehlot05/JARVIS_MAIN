...
def operation_provider(user_input):
    ...
    file_operation = chat_session.send_message(
        "Specify in one word what the user wants: create, read, update, delete, nothing, open, close; reply nothing if unrelated."
    ).text.strip().lower()
